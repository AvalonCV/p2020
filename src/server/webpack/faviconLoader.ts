...
/**
 * Stolen from @ts-tools/webpack-loader
 * https://github.com/AviVahl/ts-tools/blob/main/packages/webpack-loader/src/loader-types.ts
 */
...
const loader: WebpackLoader = function (this, content) {
    if (typeof content === 'string') {
        ...
        const favicon_configuration: Partial<favicons.FaviconOptions> = {
            path: typeof options.outputPath === 'string' ? options.outputPath : '',
            icons: {
                android: false,
                appleIcon: false,
                appleStartup: false,
